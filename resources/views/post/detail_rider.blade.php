...
@section('container')
            ...
            <form method="post" action="/update/{{ $rider->id }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label >Name</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" required id="nationality" name="nationality" value="{{ old('nationality', $rider->nationality) }}">
                </div>
                <div class="mb-3">
                    <label for="img_rider" class="form-label">image</label>
                    <input type="text" class="form-control" required id="img_rider" name="img_rider" value="{{ old('img_rider', $rider->img_rider) }}">
                </div>
                <div class="mb-3">
